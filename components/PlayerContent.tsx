  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 h-full">
      ...
      <div className="flex md:hidden col-auto w-full justify-end items-center">
        ...
        <div className="hidden w-full h-full md:flex justify-center items-center max-w-[722px] gap-x-6">
          <AiFillStepBackward
          ...
          />
          <div
            className="flex justify-center items-center w-10 h-10 rounded-full bg-white p-1 cursor-pointer"
            onClick={handlePlay}>
            <Icon className="text-black" size={30} />
          </div>
          <div>
